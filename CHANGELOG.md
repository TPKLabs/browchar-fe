...
- a new contracts publish now turns FE PRs red until the pin bump lands — accepted trade-off (visibility over convenience) decided 2026-07-16; revisit if publish frequency makes it noisy.
